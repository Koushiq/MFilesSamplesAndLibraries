...
using Welldev.AbacusMasterDataSync.AbacusSyncObjectTypeDataSource.Factories;
...
namespace Welldev.AbacusMasterDataSync.AbacusSyncObjectTypeDataSource
{
		...
		: ExternalObjectTypeConnectionBase
	{
		...
		private DataPrepareFactory dataPrepareFactory;
		/// <summary>
		...
		) : base( config, stopToken )
		{
			// Set.
			this.Config = config;
			this.dataPrepareFactory = new DataPrepareFactory(new DbConnector(this.Config));
		}
